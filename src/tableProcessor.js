...
TableProcessor.prototype.drawHorizontalLine = function (lineIndex, writer, overrideY, hasBreak = false) {
	...
	if (lineWidth) {
		...
		for (var i = 0, l = this.rowSpanData.length; i < l; i++) {
			...
			if (shouldDrawLine && i < l - 1) {
				...
				// the current cell
				if (lineIndex < body.length && !hasBreak) {
