...
class LayoutBuilder {
   ...
   * @param {boolean} hardTables - rather than overflowing the known height of table cell, throw an error
   */
  constructor(pageSize, pageMargins, svgMeasure, hardTables) {
  ...
  processRow(columns, widths, gaps, tableBody, tableRow, height) {
    ...
    this.writer.context().completeColumnGroup(height, this.hardTables);
