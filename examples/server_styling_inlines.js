	...
	content: [
		...
		{	text: 'Mixing named styles and style-overrides', style: 'header' },
		{
			...
			text: [
				...
				'For example, this paragraph uses the "bigger" style, which changes fontSize to 15 and sets italics to false. ',
				'As you\'ve noticed - texts are not italics though. It\'s because we\'ve overriden italics back to false at ',
				'the paragraph level. \n\n',
