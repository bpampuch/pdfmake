...
describe('Integration test: columns', function () {
	...
	it('renders two columns', function (done) {
		var dd = {
			content: [
				{
					alignment: 'justify',
	...
	it('renders three columns', function (done) {
		var dd = {
			content: [
				{
					columns: [
	...
	it('renders star column', function (done) {
		var dd = {
			content: [
				{
					columns: [
	...
	it('renders auto column', function (done) {
		var dd = {
			content: [
				{
					columns: [
	...
	it('renders only needed space for auto columns', function (done) {
		var dd = {
			content: [
				{
					columns: [
	...
	it('renders empty column lists', function (done) {
		var dd = {
			content: [
				{columns: []},
				{columns: [
	...
	it('render nested columns', function (done) {
		var dd = {
			content: [
				{
					columns: [
