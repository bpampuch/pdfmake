  ...
  describe('columns simple', function(){
	...
	describe('images', function () {
		it('renders next element below image', function () {
			...
			assert.equal(image.x, MARGINS.left);
			assert.equal(image.y, MARGINS.top);
			assert.equal(someElementAfterImage.x, MARGINS.left);
			assert.equal(someElementAfterImage.y, MARGINS.top + imageHeight);
		});
      ...
      var dd = {
			...
			assert.equal(someElementAfterImage.x, MARGINS.left);
			assert.equal(someElementAfterImage.y, MARGINS.top);
