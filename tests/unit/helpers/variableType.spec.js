...
const { isString, isNumber, isObject, isEmptyObject, isValue, isFunction } = require('../../../js/helpers/variableType');
...
describe('helpers/variableType', function () {
	...
	it('should be correctly specify variable with function', function () {
